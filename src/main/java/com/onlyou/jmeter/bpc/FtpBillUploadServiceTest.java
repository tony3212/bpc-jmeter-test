...
public class FtpBillUploadServiceTest extends BaseServiceTest {
	...
	private Map<String, Object> getData(JavaSamplerContext context) {
		...
		String partnerId = context.getParameter("partnerId");
		String customerId = context.getParameter("customerId");
		String accountDate = context.getParameter("AccountDate");
		String packetCode = context.getParameter("packetCode");

		data.put("ComeFrom", "Bpo-Iscan");
		data.put("FeeCode", "");
		data.put("packetCode", packetCode);
		data.put("Scanername", "华锐集团");
		data.put("QRCode", "");
		data.put("AppVersion","17102116");
		data.put("ImgSuffix", ".jpg");
		data.put("RotateImg", "");
		data.put("partnerId", partnerId);
		data.put("ModeCode", "");
		data.put("Scaneruser", "efa664dd2bb8420baad0e014b3c5daae");
		data.put("MakeDate", "20171024104942");
		data.put("SequenceNO", context.getParameter("SequenceNO"));
		data.put("ImgName", context.getParameter("ImgName", partnerId + "/" + customerId + "/" + accountDate + "/I_0/336.jpg"));
		data.put("SourceName", context.getParameter("SourceName", "336.jpg"));
		data.put("OcrType", context.getParameter("OcrType"));
		data.put("FeeID", "");
		data.put("StoreID", "");
		data.put("RecordFlag", YesNoEnum.YES.getCode());
		data.put("BatchNo", "");
		data.put("AccountDate", accountDate);
		data.put("ImgType", context.getParameter("ImgType"));
		data.put("CustCode", customerId);
		data.put("imageUri", context.getParameter("imageUri", partnerId + "/" + customerId + "/" + accountDate + "/" + packetCode + "/336.jpg"));
		data.put("packetCode", packetCode);
		data.put("branchNum", "1004");
